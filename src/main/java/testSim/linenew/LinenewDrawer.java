package testSim.linenew;import java.awt.BasicStroke;
...
public class LinenewDrawer extends Drawer {
    private Stroke stroke = new BasicStroke(8);
    private Color selectColor = new Color(0,0,255,100);
    private static org.apache.log4j.Logger log = Logger.getLogger(LinenewDrawer.class);
    @Override
    public void draw(LogicThread lt, Graphics2D g) {
        LinenewApp app = (LinenewApp) lt;
